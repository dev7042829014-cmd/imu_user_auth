...
_MODEL_DEFAULT_LOSS = {"m1a": "supcon", "m1b": "arcface",
                       ...
                       "s1a": "supcon", "s1b": "arcface",
                       "s2a": "supcon", "s2b": "arcface"}
...
def build_argparser():
    ...
    p.add_argument("--model",
                   choices=["b1", "b2", "m1", "m1a", "m1b", "m2", "m2a", "m2b",
                            "g2", "g2a", "g2b", "s1", "s1a", "s1b",
                            "s2", "s2a", "s2b"], default="b1",
                   help="b1/b2 baselines; m1 = CNN+SE; m2 = slow/fast split SE-CNN; "
                        "g2 = frequency-hybrid GRU; s1 = Swin-1D; s2 = Swin-1D + "
                        "spectral/band fusion. ?a=SupCon, ?b=ArcFace (the model "
